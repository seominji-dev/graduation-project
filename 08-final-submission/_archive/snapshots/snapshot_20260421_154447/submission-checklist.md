...
- [ ] 필수 파일 존재: `final-report.docx`, `presentation.pptx`, `handout.pdf`, `demo-scenario.md`, `script.md`, `minji/README.md`, `manifest.yaml`
- [ ] DOCX 페이지 수 18~22p
- [ ] PPTX 슬라이드 수 12~20장
- [ ] §A 교차 참조 일치 (LLM 모델명·서버 포트·Ollama 포트·대시보드 URL)
- [ ] `minji/` md 파일 12개 이상
- [ ] `source-code/`에 scheduler·llm·utils·public·routes 디렉토리 모두 존재
