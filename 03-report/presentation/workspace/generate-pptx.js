...
const layers = [
	...
	{
		name: "Storage Layer",
		items: ["Redis (BullMQ)", "MongoDB (Logs)", "LLM Service"],
		y: 4.0,
		color: colors.success,
	},
];
...
const qualityItems = [
	{ name: "테스트", desc: "777개 작성", color: colors.success },
	{ name: "커버리지", desc: "98.72%", color: colors.accent },
	{ name: "타입 안전", desc: "TypeScript", color: colors.purple },
	{ name: "코드 스타일", desc: "ESLint", color: colors.warning },
];
