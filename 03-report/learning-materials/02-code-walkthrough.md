...
> **중요 안내:** 이 문서는 초기 설계 문서로, 실제 구현과 일부 차이가 있습니다.
> - **실제 구현**: JavaScript (ES2024), 메모리 배열 큐, JSON 파일 저장소
> - **이 문서**: TypeScript 예시 코드, 더 복잡한 디렉토리 구조
>
> 실제 코드는 `02-implementation/src-simple/` 디렉토리를 참조하세요.
> 단순화된 JavaScript 버전으로 학부생 수준에 맞게 구현되어 있습니다.

> **학습 목표:** 이 문서를 읽고 나면 프로젝트의 핵심 설계 개념과 코드 실행 흐름을 이해할 수 있습니다.
