...
| NFR-1 | 부하 테스트 | QA팀 | ✅ 완료 |
| NFR-2 | 성능 테스트 | QA팀 | ✅ 완료 |
| NFR-6.2 | Jest 커버리지 | 개발팀 | ✅ 완료 (Lines: 98.93%, Branches: 85.77%) |
...
| 테스트 커버리지 - Lines (NFR-6.2) | 85%+ | 98.93% | 116% |
| 테스트 커버리지 - Statements (NFR-6.2) | 85%+ | 98.72% | 116% |
| 테스트 커버리지 - Branches (NFR-6.2) | 85%+ | 85.77% | 101% |
| 테스트 커버리지 - Functions (NFR-6.2) | 90%+ | 94.77% | 105% |
| 테스트 통과율 | 100% | 777/777 | 100% |
| 성능 개선 (NFR-1.3) | 30%+ | 40% (MLFQ), 72-88% (WFQ) | 133%+ |
| 공정성 지수 (개별 테넌트) | 0.90+ | 0.92-0.98 | 달성 |
| 공정성 지수 (가중치 정규화) | 0.95+ | 0.95 | 달성 |
