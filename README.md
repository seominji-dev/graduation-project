...
|---------|-------------------|-------------------|-------|
| Short (50-300ms) | 144,599ms | 34,540ms | **76.11%** (large-scale, 500개 요청, 시드 12345) |
| Medium (500-1500ms) | 152,458ms | 89,234ms | 41.47% |
| Long (2000-5000ms) | 167,832ms | 145,678ms | 13.21% |
| **전체 평균** | **154,963ms** | **89,817ms** | **42.04%** |

> **다중 시드 검증 (10 seeds, 선점형 시뮬레이션)**: MLFQ Short 개선율 평균 **73.78%** (95% CI: [72.36, 75.20], p<0.001, Cohen's d=15.905)
