...
[![Test Coverage](https://img.shields.io/badge/coverage-90.22%25-brightgreen)](https://github.com/YOUR_USERNAME/checkpointing)
...
| 항목 | 점수 | 설명 |
|------|------|------|
| Tested | 90/100 | 46/46 테스트 통과, 90.22% 커버리지 |
