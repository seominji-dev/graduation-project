...
== 시작하기
<시작하기>
이 가이드는 Checkpointing System을 설치, 구성, 사용하는 방법을
안내합니다. Checkpointing System은 운영체제의 프로세스 체크포인팅 기법을
AI 에이전트의 장애 복구에 적용한 시스템입니다.
